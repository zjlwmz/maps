            ...
            if (!t.id || !i("#" + t.id)[0]) {
                ...
                6 == r.ie && (t.fixed = !1),
                    ...
                    case 2:
                        ...
                        t.content = '<iframe scrolling="'+ (t.content[1]||'auto') +'" allowtransparency="true" id="'
                            + l[4] +''+ a +'" name="'+ l[4] +''+ a
                            + '" onload="this.className=\'\';" class="layui-layer-load" frameborder="0"></iframe><form id="'
                            + l[4] + '-form' + a+'" action="' + t.content[0] + '" method="post" target="'
                            + l[4] + '' + a +'">';
                ...
                // 2017-5-13 ThinkGem 支持post方式提交iframe
                if (t.type == 2){
                    var form = e.layero.find('#' + l[4] + '-form' + a), formData = t.contentFormData;
