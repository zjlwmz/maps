        ...
        1: [function(b, a) {
            !function() {
                function h(u, y) {
                    ...
                    this.touchBoundary = y.touchBoundary || 10,
                    this.layer = u,
                    this.tapDelay = y.tapDelay || 200,
                    this.tapTimeout = y.tapTimeout || 700,
                    !h.notNeeded(u)) {
                        for (var v = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], p = this, x = 0, m = v.length; m > x; x++) {
                            p[v[x]] = q(p[v[x]], p)
                        }
                        g && (u.addEventListener("mouseover", this.onMouse, !0),
                        u.addEventListener("mousedown", this.onMouse, !0),
                        u.addEventListener("mouseup", this.onMouse, !0)),
                        ...
                        "function" == typeof u.onclick && (w = u.onclick,
                ...
                h.prototype.onTouchEnd = function(q) {
                    ...
                    "label" === m) {
                        ...
                        if (this.needsFocus(o)) {
                            return q.timeStamp - v > 100 || d && window.top !== window && "input" === m ? (this.targetElement = null,
                            !1) : (this.focus(o),
                            this.sendClick(o, q),
                    ...
                    return d && !j && (s = o.fastClickScrollParent,
                    s && s.fastClickLastScrollTop !== s.scrollTop) ? !0 : (this.needsClick(o) || (q.preventDefault(),
                    this.sendClick(o, q)),
                    !1)
                }
                ,
