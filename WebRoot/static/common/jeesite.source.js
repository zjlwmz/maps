...
if (typeof jQuery === "undefined") {
    ...
    $(function() {
        ...
        $(document).on("click", ".addTabPage",
        function(e) {
            var $this = $(this),
            href = $this.data("href"),
            title = $this.data("title") || $this.attr("title") || $this.text();
            if (href && href != "" && href != "blank") {
                js.addTabPage($this, $.trim(title || "新页签"), href, null, true, false);
    ...
    var js = {
        ...
        showMessage: function(message, title, type, timeout) {
            var msgType, layerIcon, msg = String(message),
            msgTimeout = timeout == undefined ? 4000 : timeout;
            if (type == "success" || msg.indexOf("成功") >= 0) {
                msgType = "success";
                layerIcon = 1
            } else {
                if (type == "error" || msg.indexOf("错误") >= 0 || msg.indexOf("失败") >= 0) {
                    msgType = "error";
                    layerIcon = 2
                } else {
                    if (type == "warning" || msg.indexOf("不能") >= 0 || msg.indexOf("不允许") >= 0 || msg.indexOf("必须") >= 0 || msg.indexOf("已存在") >= 0 || msg.indexOf("不需要") >= 0 || msg.indexOf("不正确") >= 0) {
                        msgType = "warning";
                        layerIcon = 5
                    } else {
                        msgType = "info";
        ...
        confirm: function(message, urlOrFun, data, callback, dataType, async, loadingMessage) {
            ...
            var sendAjax = function() {
                js.loading(loadingMessage == undefined ? "正在提交，请稍后...": loadingMessage);
                $.ajax({
                    type: "POST",
                    url: urlOrFun,
                    data: data,
            ...
            js.layer.confirm(message, options,
            function(index) {
                if (typeof urlOrFun == "function") {
                    urlOrFun()
                } else {
        ...
        addTabPage: function($this, title, url, closeable, refresh) {
            ...
            if (!tabPage || typeof tabPage.addTabPage != "function") {
                if (js.layer) {
                    js.layer.open({
                        type: 2,
                        maxmin: true,
                        shadeClose: true,
                        title: title,
                        area: [($(top.window).width() - 10) + "px", ($(top.window).height() - 10) + "px"],
                        content: url,
                        success: function(layero, index) {
                            var win = js.layer.iframeWindow(index);
                            win.$(".main-content>.box-main>.box-header").hide()
                        }
                    })
                } else {
            ...
            tabPage.addTabPage($this, title, url, closeable, refresh)
        },
...
function(d) {
                ...
                if (!c) {
                    ...
                    if (b.isUseSpan == false) {
                        ...
                        if (b.onInput) {
                            ...
                            a(h).focus(function() {
                                m.hide()
                            }).blur(function() { / ^$ / .test(a(h).val()) && m.show()
                            })
                        }
                    }
                }
    ...
    function C(k, h, n) {
        var p = k[0],
        m = /er/.test(n) ? U: /bl/.test(n) ? P: V,
        l = n == j ? {
            checked: p[V],
            disabled: p[P],
            indeterminate: "true" == k.attr(U) || "false" == k.attr(o)
        }: p[m];
    ...
    function Q(y, x, u) {
        ...
        s = W(y, x + i(v[T]));
        if (!0 !== v[x]) {
            if (!u && x == V && v[T] == K && v.name) {
                var k = y.closest("form"),
                h = 'input[name="' + v.name + '"]',
                h = k.length ? k.find(h) : X(h);
                h.each(function() {
                    this !== v && X(this).data(R) && O(X(this), x)
                })
            }
            n ? (v[x] = !0, v[V] && O(y, V, "force")) : (u || (v[x] = !0), q && v[U] && O(y, U, !1));
            b(y, q, x, u)
        }
        v[P] && W(y, f, !0) && t.find("." + g).css(f, "default");
        t[B](s || W(y, x) || "");
    ...
    function O(y, x, v) {
        ...
        if (!1 !== w[x]) {
            ...
            b(y, n, l, v)
        } ! w[P] && W(y, f, !0) && s.find("." + g).css(f, "pointer");
        s[c](z || W(y, x) || "");
    ...
    function a(k, h) {
        if (k.data(R)) {
            k.parent().html(k.attr("style", k.data(R).s || ""));
            if (h) {
                k[S](h)
            }
            k.off(".i").unwrap();
            X(A + '[for="' + k[0].id + '"]').add(k.closest(A)).off(".i")
        }
    }
    function W(k, h, l) {
        if (k.data(R)) {
            return k.data(R).o[h + (l ? "": "Class")]
        }
    }
    function i(h) {
    ...
    X.fn[R] = function(D, v) {
        var s = 'input[type="checkbox"], input[type="' + K + '"]',
        t = X(),
        q = function(k) {
            k.each(function() {
                var w = X(this);
        ...
        if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(D)) {
            ...
            t.each(function() {
                var k = X(this);
                "destroy" == D ? a(k, "ifDestroyed") : C(k, !0, D);
                X.isFunction(v) && v()
            })
        }
        ...
        return t.each(function() {
            ...
            y = "checkbox" == I[T] ? p.checkboxClass || "icheckbox": p.radioClass || "i" + K,
            x = X(A + '[for="' + J + '"]').add(L.closest(A)),
            w = !!p.aria,
            M = R + "-" + Math.random().toString(36).replace("0.", ""),
            F = '<div class="' + y + '" ' + (w ? 'role="' + I[T] + '" ': "");
            x.length && w && x.each(function() {
                F += 'aria-labelledby="';
                this.id ? F += this.id: (this.id = M, F += M);
                F += '"'
            });
            F = L.wrap(F + "/>")[S]("ifCreated").parent().append(p.insert);
            H = X('<ins class="' + g + '"/>').css(H).appendTo(F);
            L.data(R, {
                o: p,
                s: L.attr("style")
            }).css(G);
            p.inheritClass && F[B](I.className || "");
            p.inheritID && J && F.attr("id", R + "-" + J);
            "static" == F.css("position") && F.css("position", "relative");
            C(L, !0, j);
            if (x.length) {
                x.on("click.i mouseover.i mouseout.i touchbegin.i touchend.i",
                function(k) {
                    var Z = k[T],
                    Y = X(this);
                    if (!I[P]) {
                        if ("click" == Z) {
                            ...
                            u && (/ut|nd/.test(Z) ? (F[c](m), Y[c](l)) : (F[B](m), Y[B](l)))
                        }
                        if (d) {
                            k.stopPropagation()
                        } else {
            ...
            L.on("click.i focus.i blur.i keyup.i keydown.i keypress.i",
            function(k) {
                var Y = k[T];
                k = k.keyCode;
                if ("click" == Y) {
                ...
                if ("keydown" == Y && 32 == k) {
                    return I[T] == K && I[V] || (I[V] ? O(L, V) : Q(L, V)),
                    !1
                }
                if ("keyup" == Y && I[T] == K) { ! I[V] && Q(L, V)
                } else {
                    if (/us|ur/.test(Y)) {
                        F["blur" == Y ? c: B](z)
                    }
            ...
            H.on("click mousedown mouseup mouseover mouseout touchbegin.i touchend.i",
            function(k) {
                var Z = k[T],
                Y = /wn|up/.test(Z) ? E: m;
                if (!I[P]) {
...
})(window.jQuery || window.Zepto); (function(f, d, a) {
    var b, g, c;
    c = "resizeEnd";
    g = {
        delay: 150
        ...
        1 : [function(b, a) { !
            function() {
                function h(u, y) {
                    ...
                    var w;
                    if (y = y || {},
                    this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = y.touchBoundary || 10, this.layer = u, this.tapDelay = y.tapDelay || 200, this.tapTimeout = y.tapTimeout || 700, !h.notNeeded(u)) {
                        for (var v = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], p = this, x = 0, m = v.length; m > x; x++) {
                            p[v[x]] = q(p[v[x]], p)
                        }
                        g && (u.addEventListener("mouseover", this.onMouse, !0), u.addEventListener("mousedown", this.onMouse, !0), u.addEventListener("mouseup", this.onMouse, !0)),
                        u.addEventListener("click", this.onClick, !0),
                        u.addEventListener("touchstart", this.onTouchStart, !1),
                        u.addEventListener("touchmove", this.onTouchMove, !1),
                        u.addEventListener("touchend", this.onTouchEnd, !1),
                        u.addEventListener("touchcancel", this.onTouchCancel, !1),
                        Event.prototype.stopImmediatePropagation || (u.removeEventListener = function(s, t, o) {
                            var l = Node.prototype.removeEventListener;
                            "click" === s ? l.call(u, s, t.hijacked || t, o) : l.call(u, s, t, o)
                        },
                        u.addEventListener = function(s, t, o) {
                            var l = Node.prototype.addEventListener;
                            "click" === s ? l.call(u, s, t.hijacked || (t.hijacked = function(i) {
                                i.propagationStopped || t(i)
                            }), o) : l.call(u, s, t, o)
                        }),
                        "function" == typeof u.onclick && (w = u.onclick, u.addEventListener("click",
                        function(i) {
                            w(i)
                        },
                        !1), u.onclick = null)
                ...
                h.prototype.focus = function(l) {
                    var i;
                    d && l.setSelectionRange && 0 !== l.type.indexOf("date") && "time" !== l.type && "month" !== l.type ? (i = l.value.length, l.setSelectionRange(i, i)) : l.focus()
                },
                h.prototype.updateScrollParent = function(l) {
                    var i, m;
                    if (i = l.fastClickScrollParent, !i || !i.contains(l)) {
                        m = l;
                        do {
                ...
                h.prototype.onTouchStart = function(m) {
                    ...
                    if (i = this.getTargetElementFromEventTarget(m.target), o = m.targetTouches[0], d) {
                        if (l = window.getSelection(), l.rangeCount && !l.isCollapsed) {
                            return ! 0
                        }
                        if (!j) {
                ...
                h.prototype.onTouchMove = function(i) {
                    return this.trackingClick ? ((this.targetElement !== this.getTargetElementFromEventTarget(i.target) || this.touchHasMoved(i)) && (this.trackingClick = !1, this.targetElement = null), !0) : !0
                },
                ...
                h.prototype.onTouchEnd = function(q) {
                    var p, v, m, s, i, o = this.targetElement;
                    ...
                    if (this.cancelNextClick = !1, this.lastClickTime = q.timeStamp, v = this.trackingClickStart, this.trackingClick = !1, this.trackingClickStart = 0, f && (i = q.changedTouches[0], o = document.elementFromPoint(i.pageX - window.pageXOffset, i.pageY - window.pageYOffset) || o, o.fastClickScrollParent = this.targetElement.fastClickScrollParent), m = o.tagName.toLowerCase(), "label" === m) {
                        ...
                        if (this.needsFocus(o)) {
                            return q.timeStamp - v > 100 || d && window.top !== window && "input" === m ? (this.targetElement = null, !1) : (this.focus(o), this.sendClick(o, q), d && "select" === m || (this.targetElement = null, q.preventDefault()), !1)
                        }
                    }
                    return d && !j && (s = o.fastClickScrollParent, s && s.fastClickLastScrollTop !== s.scrollTop) ? !0 : (this.needsClick(o) || (q.preventDefault(), this.sendClick(o, q)), !1)
                },
                ...
                h.prototype.onMouse = function(i) {
                    return this.targetElement ? i.forwardedTouchEvent ? !0 : i.cancelable && (!this.needsClick(this.targetElement) || this.cancelNextClick) ? (i.stopImmediatePropagation ? i.stopImmediatePropagation() : i.propagationStopped = !0, i.stopPropagation(), i.preventDefault(), !1) : !0 : !0
                },
                h.prototype.onClick = function(l) {
                    var i;
                    return this.trackingClick ? (this.targetElement = null, this.trackingClick = !1, !0) : "submit" === l.target.type && 0 === l.detail ? !0 : (i = this.onMouse(l), i || (this.targetElement = null), i)
                },
                h.prototype.destroy = function() {
                    var i = this.layer;
                    g && (i.removeEventListener("mouseover", this.onMouse, !0), i.removeEventListener("mousedown", this.onMouse, !0), i.removeEventListener("mouseup", this.onMouse, !0)),
                ...
                h.notNeeded = function(p) {
                    ...
                    if (s = +(/Chrome\/([0-9]+)/.exec(navigator.userAgent) || [, 0])[1]) {
                        ...
                        if (m = document.querySelector("meta[name=viewport]")) {
                            ...
                            if (s > 31 && document.documentElement.scrollWidth <= window.outerWidth) {
                                return ! 0
                            }
                        }
                    }
                    if (c && (l = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/), l[1] >= 10 && l[2] >= 3 && (m = document.querySelector("meta[name=viewport]")))) {
                        if ( - 1 !== m.content.indexOf("user-scalable=no")) {
                            return ! 0
                        }
                ...
                "function" == typeof define && "object" == typeof define.amd && define.amd ? define(function() {
                    return h
                }) : "undefined" != typeof a && a.exports ? (a.exports = h.attach, a.exports.FastClick = h) : window.FastClick = h
            } ()
        },
        {}],
        2 : [function(a) {
...
function(a, c) {
    ...
    a.fn.dropdownHover = function(d) {
        return "ontouchstart" in document ? this: (b = b.add(this.parent()), this.each(function() {
            function f() {
                m.parents(".navbar").find(".navbar-toggle").is(":visible") || (c.clearTimeout(o), c.clearTimeout(j), j = c.setTimeout(function() {
                    b.find(":focus").blur(),
...
function() {
    ...
    a.pt.parse = function(k, q) {
        ...
        i = g("^" + d.open + "#", ""),
        h = g(d.close + "$", "");
        k = k.replace(/\s+|\r|\t|\n/g, " ").replace(g(d.open + "#"), d.open + "# ").replace(g(d.close + "}"), "} " + d.close).replace(/\\/g, "\\\\").replace(/(?="|')/g, "\\").replace(b.query(),
        function(c) {
        ...
        function(l) {
            var c = '"+(';
            return l.replace(/\s/g, "") === d.open + d.close ? "": (l = l.replace(g(d.open + "|" + d.close), ""), /^=/.test(l) && (l = l.replace(/^=/, ""), c = '"+_escape_('), c + l.replace(/\\/g, "") + ')+"')
        }),
    ...
    a.pt.render = function(i, k) {
        var h, j = this;
        return i ? (h = j.cache ? j.cache(i, b.escape) : j.parse(j.tpl, i), console.log(), k ? void k(h) : h) : b.error("no data")
    };
    var f = function(c) {
